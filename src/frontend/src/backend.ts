...
export class Backend implements backendInterface {
    ...
    async addVisitorRecord(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async exportVisitorRecords(): Promise<Array<EntryIdVisitorRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.exportVisitorRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSortedVisitorRecords(): Promise<Array<EntryIdVisitorRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSortedVisitorRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unlockAdminPrivileges(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.unlockAdminPrivileges(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
